# 🏋️ RAG Pipeline Stress Tester

> Adversarial load tester generating concurrent queries to measure search latency and system drifts.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/rag-stress-tester/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-rag-stress-tester.git
cd tp-rag-stress-tester
```
...
```bash
kubectl port-forward deployment/tp-rag-stress-tester 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── stress_tester.py     # Main configuration file
```
...
---
*Generated by [RAG Pipeline Stress Tester Studio](https://pradeeptalari14.github.io/portfolio/tools/rag-stress-tester/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
